...
//    }
//
//    override fun appendSpan(index: Int) {
//        super.appendSpan(index)
//        setDrawableSpan(index)
//    }
//
...
//        curIndex = index
//
//        val start = Algorithms.findStartingPosOfPattern(
//            string,
//            token.toString()
//        ) + getStartingPos(index)
//
////        spannable.replace(start, start + token.length, string)
//
...
//            ), start, start + token.length, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE
//        )
//
////        spannable.setSpan(newStart, newEnd)
//    }
